...
def _get_chain():
    prompt_from_langfuse = langfuse.get_prompt("Correction_cue")
...
def generate_corrections(biomechanics_report: dict) -> str:
    """
    Generates top biomechanical corrections
    for a bowler.
    """

    with langfuse.start_as_current_observation(name="correction-analysis-chain"):
        chain = _get_chain()
